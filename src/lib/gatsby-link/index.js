...
/**
 * Forked form gatsby-link https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-link
 */
...
import { parsePath } from 'gatsby-link/parse-path';
...
function normalizePath(path) {
  return path.replace(/\/+/g, `/`).replace('https:/', 'https://');
}
